              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 gap-3">
                  {tweetTemplates.map((template) => (
                    <label 
                      key={template.id} 
                      className={`group flex items-center p-4 rounded-2xl border-2 transition-all duration-300 cursor-pointer transform hover:scale-[1.02] hover:shadow-lg ${
              ...
              {(generatedTweet || editedTweet) && (
                <div className="apple-slide-up">
                  <button
                    ...
                    className={`w-full py-5 rounded-2xl font-bold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] text-lg ${
